...
<div class="col-sm-12">
	...
	<ul class="breadcrumb">
		...
		<li class="breadcrumb-item active">Ajouter Equipement démo</li>
	</ul>
</div>
@endpush
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body custom-edit-service">
				...
				<!-- Add equipement -->
				<form method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('equipementdemos.store')}}">
					@csrf
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="designation" placeholder="Saisir la désignation de l'équipement">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input class="form-control" type="date" name="date_entree" placeholder="Saisir la date d'entrée de la marchandise">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									<label>Garantie</label>
									<input type="text" name="garantie" class="form-control" placeholder="Saisir la durée de garantie">
								</div>
							</div>
						</div>
					</div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="fiche_technique" class="form-control" placeholder="Importer la fiche technique">
                                </div>
                            </div>
                        </div>
                    </div>
